...
<template>
  <Form :validation-schema="Loginform" @submit="handleLogin">
    <!-- <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
            <p cass="lead fw-normal mb-0 me-3">D</p>
    ...
    <div class="d-flex justify-content-between align-items-center">
      ...
      <div class="form-check mb-0">
        <input
          ...
          @click="showPwd()"
        />
        <label class="form-check-label" for="checkpwd"> Hiện mật khẩu </label>
      </div>
    </div>
    <div class="text-center tex t-lg-start mt-4 pt-2">
      ...
      <p class="small fw-bold mt-2 pt-1 mb-3">
        Bạn chưa có tài khoản?
        <router-link to="/logup" class="link-danger">Đăng ký ngay</router-link>
      </p>
    </div>
  </Form>
</template>
