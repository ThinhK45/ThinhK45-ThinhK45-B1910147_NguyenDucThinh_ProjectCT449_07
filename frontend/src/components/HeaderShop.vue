  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-header">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">
        <img
          src="https://bizweb.dktcdn.net/100/480/007/themes/899663/assets/logo.png?1681976331867"
          alt="beatme.info"
          style="width: 66px"
        />
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="#shirts">Áo thể thao</a></li>
              <li><a class="dropdown-item" href="#shirts">Áo thể thao</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="#shirts">Áo</a></li>
              <li><a class="dropdown-item" href="#polo">Áo polo</a></li>

              <li><a class="dropdown-item" href="#shorts">Quần</a></li>
            </ul>
          </li>
        </ul>
        <form class="d-flex flex-mb">
          <input
            ...
            aria-label="Search"
          />
          <button class="btn btn-header" type="button" @click="slideSearch()">
            <i class="bi bi-search icon text-white"></i>
          </button>
        </form>
        ...
        <div class="Cart">
          <div class="wrapper_cart">
            <div class="cart_link" id="cart_link">
              <div class="card card-body bg-header cart-info">
                <div class="cart-list">
            ...
            <i class="bi bi-bag-fill icon icon_cart text-white"></i>
        ...
        <div class="User">
          <div class="not-login">
            ...
            <div class="collapse user_link" id="user">
              <div class="card card-body bg-header connect-shop">
          ...
          <div class="login">
            ...
            <div class="collapse user_link" id="user">
              <div class="card card-body bg-header connect-shop">
                <router-link to="/profile" class="text-white text-center"
                  >Trang cá nhân</router-link
                >
                <a to="/" class="text-white text-center" @click="handlelogout()"
                  >Đăng xuất</a
                >
              </div>
            </div>
