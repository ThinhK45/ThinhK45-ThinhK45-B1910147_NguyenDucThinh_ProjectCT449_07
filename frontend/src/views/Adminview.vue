...
export default {
  ...
  methods: {
    ...
    onChangeColor(e) {
      // var isActive = e.target.className.includes("active");
      if (this.isActive) {
...
<template>
  ...
  <div class="main_admin d-flex" style="margin-top: 30px; margin-left: 100px">
    <ul class="list-group li-menu col-2 h-25 me-3">
      <li
    ...
    <div class="list_users w-100" v-if="isShow">
      ...
      <div class="list_item_user d-flex" id="user">
        ...
        ></ListUser>
        <div
          class="card_product border border-light border-2 h-100 bg-light text-dark ms-3"
          style="padding: 10px"
          v-if="getindexuser"
        >
    ...
    <div class="list_products" v-else>
      ...
      <router-link to="/addproduct">
        <button class="btn btn-success my-3">Thêm Sản phẩm</button>
      </router-link>
    </div>
  </div>
</template>
