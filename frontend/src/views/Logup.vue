  ...
  <section class="text-center text-lg-start">
    <div class="container py-4">
      <div class="row g-0 align-items-center d-flex justify-content-center">
          ...
          >
            <div class="card-body p-5 shadow-5 text-center">
              ...
              <Form :validation-schema="Logupform">
                ...
                <p>
                  Nếu bạn đã có tài khoản hãy<router-link to="/login">
        ...
        <!-- <div class="col-lg-6 mb-5 mb-lg-0">
          <img
            src="https://atpsoftware.vn/wp-content/uploads/2020/02/Nh%E1%BA%ADn-bi%E1%BA%BFt-Register-l%C3%A0-g%C3%AC.jpg"
